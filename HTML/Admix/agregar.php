      ...
      $("#botonAgregar").click(function(){ 
        ...
        $.get("../JSON/Servidor",{servidor:servidor}, function(nomServer){
          $.get("../JSON/Fuente",{fuente:fuente}, function(nomFuente){
            ...
            table.row.add( [
              cont,
              nomServer  +"<input type='hidden' class='form-control' name='nomServer_"+cont+"' value='"+servidor+"'>",
              nomFuente  +"<input type='hidden' class='form-control' name='nomFuente_"+cont+"' value='"+fuente+"'>",
